...
import { AbstractVolumeButton } from '../../base/toolbox';
...
/**
 * The type of the React {@code Component} props of {@link VolumeMuteButton}.
 */
 ...
 *
 * @extends AbstractVolumeButton
 */
class VolumeMuteButton extends AbstractVolumeButton<Props, *> {
...
export default translate(connect(_mapStateToProps)(VolumeMuteButton));
